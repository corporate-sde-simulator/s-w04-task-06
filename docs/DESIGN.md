# Architecture Decision Record - Bulk data import with error recovery
...
Implement Bulk data import with error recovery using industry-standard patterns appropriate for java and our platform requirements.
